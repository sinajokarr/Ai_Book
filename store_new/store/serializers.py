...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ["id", "name", "slug", "description", "unit_price", "inventory", "category", "datetime_created", "tax"]
        read_only_fields = ["id", "slug", "datetime_created"]

    def get_tax(self, product):
        if product.unit_price is None:
            return None
        return (product.unit_price * Decimal("0.10"))
